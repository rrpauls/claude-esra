...
If the user explicitly asks to execute and persist a local command comparison, use the plugin runtime described in `../../docs/RUNTIME.md`; preserve the same authorization, guardrail, and rollback boundaries. The runtime is optional for experiment design.
